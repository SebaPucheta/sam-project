...
const create_car_1 = __importDefault(require("../../../application/use-cases/create-car"));
...
class PostCarHandler {
    ...
    async handle(params) {
        try {
            (0, validation_utils_1.validate)(params, (0, validation_utils_1.applyRequiredProperties)(post_car_body_1.carSchema));
...
exports.handler = middy_lambda_builder_1.MiddyLambdaBuilder.getNewBuilder(postCarHandler)
    ...
    .build();
//# sourceMappingURL=post-car.js.map